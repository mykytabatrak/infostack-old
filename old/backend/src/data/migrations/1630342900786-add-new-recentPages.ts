...
export class addNewRecentPages1630342900786 implements MigrationInterface {
    name = 'addNewRecentPages1630342900786';
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query('ALTER TABLE "recent_page" ADD CONSTRAINT "FK_a9f401a3220a973ea6fae2b4f23" FOREIGN KEY ("pageId") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION');
    }
